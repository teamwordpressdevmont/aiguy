...
@section('content')
    ...
    <div class="flex">
        <h4 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">AI Tool Category List</h4>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-4">
                                ...
                                <a href="{{ route('category.delete', $category->id) }}" onclick="return confirm('Are you sure you want to delete this tool?');">
